...
namespace eCommerce.Controllers
{
    ...
    public class DireccionesController : BaseController
    {
        ...
        {
            var appDbContext = _context.Direcciones.Include(d => d.Usuario);
        ...
        public async Task<IActionResult> Create([Bind("DireccionId,Address,Provincia,Ciudad,CodigoPostal,UsuarioId")] Direccion direccion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DireccionId,Address,Provincia,Ciudad,CodigoPostal,UsuarioId")] Direccion direccion)
        {
